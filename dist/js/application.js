...
var FieldRegistry = /*#__PURE__*/function () {
  /**
   * @param {Array} data
   */
  ...
  _createClass(FieldRegistry, [{
    ...
    value: function getDefinition(field) {
      var _iterator2 = _createForOfIteratorHelper(this.definitions),
          _step2;
...
var MapCoordinates = /*#__PURE__*/function () {
  /**
   * @param element
   * @param {Object} config
   */
 ...
 */
var ObjectRelation = /*#__PURE__*/function () {
...
var RichTextCompact = /*#__PURE__*/function (_RichText) {
  _inherits(RichTextCompact, _RichText);

  var _super = _createSuper(RichTextCompact);
...
var SlugApiHandler = /*#__PURE__*/function () {
  /**
   * @param {string} apiUrl
...
module.exports = __webpack_require__(/*! /Users/richard/Sites/arbory_dev/arbory/resources/assets/js/application.js */"./resources/assets/js/application.js");
